...
class NITU0905_02_Add(AddInfo): # 從AddInfo子繼承過來 
    def __init__(self, playwright: Playwright):
        super().__init__(playwright)

        # 投資型商品錄入
    def NITU0905_02_Add(self, product):
    ...
    def BenefitPeople_NITU0905_02_NTD(self, BenefitInfo):
        # time.sleep(2)
        # print("進入自己的投資方法")
    ...
    def ImportInf_NITU0905_02_NTD(self):
    ...
    def InvestReport_NITU0905_02(self,personinfo):
        self.page2.touchscreen.tap(100,100)
        self.page2.once("dialog", lambda dialog: dialog.accept())
        with self.page2.expect_popup() as popup_info:
